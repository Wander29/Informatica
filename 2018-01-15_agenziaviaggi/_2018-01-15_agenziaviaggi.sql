...
--
-- Host: 127.0.0.1
-- Creato il: Gen 15, 2018 alle 20:00
...
--
-- Database: `[2018-01-15]agenziaviaggi`
--
...
INSERT INTO `acquisti` (`CodAcq`, `CodCli`, `CodPac`, `DataAcquisto`, `quantita`) VALUES
(1, 10, 5, '2014-11-01', 3),
(2, 8, 5, '2014-11-01', 1),
(3, 16, 6, '2014-11-03', 2),
(4, 10, 1, '2014-11-05', 2),
...
--
DELIMITER $$
CREATE TRIGGER `ControlloQuantitàMaxDestinazioni` AFTER INSERT ON `pacchetto` FOR EACH ROW IF  3 < ( 
	SELECT COUNT(*)
	FROM pacchetto
...
DELIMITER ;
DELIMITER $$
CREATE TRIGGER `VariazionePrezzo` AFTER UPDATE ON `pacchetto` FOR EACH ROW IF
...
ALTER TABLE `acquisti`
  ADD PRIMARY KEY (`CodAcq`),
  ADD KEY `CodCli` (`CodCli`,`CodPac`),
...
ALTER TABLE `pacchetto`
  ...
  ADD KEY `CodDest` (`CodDest`),
  ADD KEY `CodTO` (`CodTO`);

--
-- Indici per le tabelle `touroperator`
--
ALTER TABLE `touroperator`
  ADD PRIMARY KEY (`CodTO`);
...
--
ALTER TABLE `acquisti`
  MODIFY `CodAcq` int(4) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=17;
--
-- AUTO_INCREMENT per la tabella `cliente`
--
ALTER TABLE `cliente`
  MODIFY `CodCli` int(4) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=19;
--
-- AUTO_INCREMENT per la tabella `destinazione`
--
ALTER TABLE `destinazione`
  MODIFY `CodDest` int(3) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=20;
--
-- AUTO_INCREMENT per la tabella `pacchetto`
--
ALTER TABLE `pacchetto`
  MODIFY `CodPac` int(4) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=16;
--
